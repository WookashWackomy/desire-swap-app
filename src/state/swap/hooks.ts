...
import { useBestV3TradeExactOut, useBestV3TradeExactIn, V3TradeState } from '../../hooks/useBestV3Trade';
...
export function useDerivedSwapInfo(): {
  ...
  inputError?: string;
  v3Trade: { trade: V3Trade<Currency, Currency, TradeType> | undefined; state: V3TradeState };
  ...
  const [balanceIn, amountIn] = [currencyBalances[Field.INPUT], v3Trade?.trade?.maximumAmountIn(allowedSlippage)];
