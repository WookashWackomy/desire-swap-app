...
import { Currency, Percent, TradeType } from 'sdkCore/index';
...
function useSwapCallArguments(
  ...
  const argentWalletContract = useArgentWalletContract() as unknown as Contract; //TODO unknown
          ...
          swapCalls.map((call) => {
            ...
            return library
              ...
              .catch(() => {
                ...
                return {
                  call,
                  gasEstimate: BigNumber.from(10_000_000),
                };
                // return library
                //   .call(tx)
                //   .then((result) => {
