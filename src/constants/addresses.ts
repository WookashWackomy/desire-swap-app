...
export const MULTICALL_ADDRESS: AddressMap = {
  ...
  [SupportedChainId.HARDHAT]: DESIRE_SWAP_HARDHAT_ADDRESSES.DSMulticall,
  [SupportedChainId.KONRAD]: DESIRE_SWAP_HARDHAT_ADDRESSES.DSMulticall,
...
export const QUOTER_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.HARDHAT]: DESIRE_SWAP_HARDHAT_ADDRESSES.Quoter,
  [SupportedChainId.KONRAD]: DESIRE_SWAP_HARDHAT_ADDRESSES.Quoter,
};
...
export const DESIRE_SWAP_V0_LIQUIDITY_MANAGER_ADDRESS: AddressMap = {
  ...
  [SupportedChainId.HARDHAT]: DESIRE_SWAP_HARDHAT_ADDRESSES.LiquidityManager,
  [SupportedChainId.KONRAD]: DESIRE_SWAP_HARDHAT_ADDRESSES.LiquidityManager,
};
...
export const SWAP_ROUTER_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.HARDHAT]: DESIRE_SWAP_HARDHAT_ADDRESSES.SwapRouter,
  [SupportedChainId.KONRAD]: DESIRE_SWAP_HARDHAT_ADDRESSES.SwapRouter,
};
